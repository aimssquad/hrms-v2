...
Route::post('superadmin/bill/rule/store','App\Http\Controllers\organization\BillController@ruleStore')->name('bill.rule.store');
Route::get('/billing-rule/edit/{id}', 'App\Http\Controllers\organization\BillController@edit')->name('billing-rule.edit');
...
Route::get('superadmin/login_page_file','App\Http\Controllers\AdminController@view_login_file_dtl');
Route::get('superadmin/login_file_form','App\Http\Controllers\AdminController@view_login_file_form');
Route::post('superadmin/upload-video-image', 'App\Http\Controllers\AdminController@upload')->name('upload.video.image');
Route::get('superadmin/upload-video-image/{id}/edit', 'App\Http\Controllers\AdminController@edit')->name('edit.video.image');
Route::put('superadmin/upload-video-image/{id}', 'App\Http\Controllers\AdminController@upload')->name('update.video.image');
Route::get('/superadmin/login/delete/{id}','App\Http\Controllers\AdminController@deleteLoginVideo')->name('login.video.delete');
// Insert route
...
Route::get('superadmin/registration_page_file','App\Http\Controllers\AdminController@view_register_file_dtl');
Route::get('superadmin/register_file_form','App\Http\Controllers\AdminController@view_register_file_form');
Route::post('superadmin/upload_register_video_image','App\Http\Controllers\AdminController@uplode_image');
Route::get('/superadmin/register/delete/{id}','App\Http\Controllers\AdminController@deleteVideo')->name('video.delete');

Route::post('superadmin/upload-register-video-image', 'App\Http\Controllers\AdminController@uplode_image')->name('upload.register.video.image');
Route::get('superadmin/upload-register-video-image/{id}/edit', 'App\Http\Controllers\AdminController@registeredit')->name('register.edit.video.image');
Route::put('superadmin/upload-register-video-image/{id}', 'App\Http\Controllers\AdminController@uplode_image')->name('update.register.video.image');

//---------------------------------------------End Login And Registration Slide image Video --------------------------
...
Route::get('super-admin/quick-links', 'App\Http\Controllers\organization\OrganizationController@quick_links')->name('organization.quik_links');
...
Route::get('billing/list', 'App\Http\Controllers\organization\BillController@index')->name('billing.list');
...
Route::get('rota-org/visitor-dashboard', 'App\Http\Controllers\organization\RotaController@visitorDashboard');
...
Route::post("org-fileManagment/saveFolder","App\Http\Controllers\organization\FilemanagmentControler@saveFolderUpload");
Route::get('org-fileManagment/file-add/{id}', 'App\Http\Controllers\organization\FilemanagmentControler@fileAdd')->name('org-file.add');
Route::post("org-fileManagment/saveUpload","App\Http\Controllers\organization\FilemanagmentControler@saveFileUpload");
Route::post('org-fileManagment/updateUpload', 'App\Http\Controllers\organization\FilemanagmentControler@managerupdate');
Route::get('org-fileManagment/file-name-delete/{id}/{orgId}', 'App\Http\Controllers\organization\FilemanagmentControler@filedeleted');
...
Route::get('org-task-management/{id}/tasks', 'App\Http\Controllers\organization\TaskController@dashboard');

Route::get('org-task-management/{id}/project-members', 'App\Http\Controllers\organization\MembersController@index');
...
Route::get('org-task-management/{id}/label-del/{label_id}', 'App\Http\Controllers\organization\LabelController@deleteLabel');
...
Route::get('org-recruitment/edit-hired/{hired_id}', 'App\Http\Controllers\organization\RecruitmentController@viewhiredcandidatedetails');
Route::post('org-recruitment/edit-hired', 'App\Http\Controllers\organization\RecruitmentController@savehiredcandidatedetails');
