...
<head>
    ...
    <title>Follow-Up Reminder: Your Visa Expires in 60 Days</title>
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            ...
                            <p style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; color: #333;">
                                We hope this email finds you well. This is a reminder that your visa is set to expire on <strong>{{date('d/m/Y',strtotime($offer->visa_exp_date))}},</strong> 60 days from today. To maintain your
