    ...
    <div class="content">
        <div class="page-inner">
            <div class="page-header">
                @php 
                    $project = DB::table('projects')->where('id',$project_id)->select('title')->first();
                @endphp
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">{{\App\Helpers\Helper::cachedTrans('Master Labels')}}</a></li>  
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{url('org-task-management/'.request()->route('id').'/label-del/'.encrypt($l->id))}}" class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
...
//         submitHandler: function(form) {
//             $.ajax({
//                 url: `/org-task-management/${id}/labels`, // Make sure `id` is defined
//                 method: "POST",
//                 headers: {
