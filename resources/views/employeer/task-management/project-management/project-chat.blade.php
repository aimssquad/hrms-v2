                     ...
                     <div class="d-flex flex-column h-100">
                        ...
                        <div class="border-top p-3 bg-light">
                           ...
                           <div class="d-flex align-items-center">
                              <div class="avatar-circle bg-success text-white rounded-circle me-2"
                              ...
                              <div>
                                 <h6 class="mb-0 text-dark">{{ \App\Helpers\Helper::cachedTrans($groupedData['project']['title']) }}</h6>
                  ...
                  <div class="col-md-8 d-flex flex-column" style="height: calc(100vh - 120px);">
                     ...
                     <div class="d-flex align-items-center p-3 border-bottom bg-white">
                        <div class="d-flex align-items-center">
                           ...
                           {{-- <div>
                              <h5 class="mb-0 text-dark">{{ \App\Helpers\Helper::cachedTrans($groupedData['project']['title']) }}</h5>
                           ...
                           <div class="d-flex align-items-center gap-2">
                              ...
                              <div class="btn-group">
                                 ...
                                 <ul class="dropdown-menu">
                                       <li><a class="dropdown-item" href="#" onclick="downloadChatCSV()">
                                          <i class="fas fa-file-csv"></i> Download as CSV
                                       </a></li>
                                       <li><a class="dropdown-item" href="#" onclick="downloadChatPDF()">
                                          <i class="fas fa-file-pdf"></i> Download as PDF
                                       </a></li>
                                       <li><a class="dropdown-item" href="#" onclick="downloadChatExcel()">
