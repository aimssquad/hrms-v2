                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td><?php //echo $l->status; 
                                                        ?></td> -->
                                            <td>
                                                <a href="{{url('org-task-management/'.request()->route('id').'/role-del/'.encrypt($l->id))}}" class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="fa fa-trash"></i></a>
