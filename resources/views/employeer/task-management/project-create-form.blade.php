...
@section('title', \App\Helpers\Helper::cachedTrans('Add New Project'))
@section('content')
            ...
            <div class="col-md-12">
               ...
               <div class="card custom-card">
                  <div class="card-header">
                     <h4 class="card-title"><i class="far fa-user"></i>{{\App\Helpers\Helper::cachedTrans('Add New Project')}} </h4>
                  </div>
                            ...
                            <form id="frm_project_create" method="POST" action="{{url('org-projects/add')}}">
                                ...
                                <div class="lv-due" style="border:none;">
                                    <div class="row form-group lv-due-body">
                                        <div class="col-md-6">
                                            <label class="col-fprm-label">{{\App\Helpers\Helper::cachedTrans('Project Title')}} <span>(*)</span></label>
                                            <input type="text" class="form-control" name="title" />

                                        </div>
                                        <div class="col-md-6">
                                            <label class="col-fprm-label">{{\App\Helpers\Helper::cachedTrans('Identifier')}} <span>(*)</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label class="col-fprm-label">{{\App\Helpers\Helper::cachedTrans('Description')}} <span>(*)</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 btn-up">
                                            <button class="btn btn-primary" type="submit" id="btn_project_create">{{\App\Helpers\Helper::cachedTrans('Submit')}}</button>
                                        </div>
