                        ...
                        <table class="table table-hover border m-0 p-0">
                            <tr>
                             ...
                             <tr>
                                ...
                                <td><span class="badge text-bg-danger">{{date("d-m-Y",strtotime($p->project_end_date))}}</span></td>
                            </tr>
                             <tr>
                                <th>{{\App\Helpers\Helper::cachedTrans('Message Center:')}}</th>
                                <td><a href="{{url('/org-task-management/'.encrypt($p->id).'/chat')}}" type="button" class="btn btn-primary"><i class="fa fa-comment-dots"></i></a></td>
                            </tr>
                        </table>
