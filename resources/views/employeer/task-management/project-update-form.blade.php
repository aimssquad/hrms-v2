                            ...
                            <form id="frm_project_update" method="POST" action="{{url('org-projects/update')}}">
                                ...
                                <div class="lv-due" style="border:none;">
                                    <div class="row form-group lv-due-body">
                                        ...
                                        <div class="col-md-6">
                                            <label class="col-form-label">{{\App\Helpers\Helper::cachedTrans('Project Start Date')}} <span>(*)</span></label>
                                            <input type="date" class="form-control" name="project_start_date" value="{{$project->project_start_date}}" />

                                        </div>
                                        <div class="col-md-6">
                                            <label class="col-form-label">{{\App\Helpers\Helper::cachedTrans('Project End Date')}} <span>(*)</span></label>
                                            <input type="date" class="form-control" name="project_end_date" value="{{$project->project_end_date}}" />
