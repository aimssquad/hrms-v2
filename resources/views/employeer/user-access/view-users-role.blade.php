...
<div class="content container-fluid pb-0">
	...
	<div class="page-header">
		<div class="row align-items-center">
			<div class="col">
				<h3 class="page-title">Access Roles</h3>
				<ul class="breadcrumb">
			...
			<div class="col-auto float-end ms-auto">
				...
				<a href="{{url('user-access-role/user-role')}}" class="btn add-btn"><i class="fa-solid fa-plus"></i> Add  Access Roles</a>
				@endif
				@endforeach
	...
	<div class="row">
        <div class="card custom-card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="card-title">
                    <i class="far fa-file" aria-hidden="true" style="color:#ffa318;"></i>&nbsp;Access Roles
                </h4>
                <div class="row">
                   <div class="col-auto">
                       <form action="{{ route('exportTableData') }}" method="POST" id="exportForm" class="d-inline">
                           ...
                           <input type="hidden" id="filenameInput" value="Access Roles">
