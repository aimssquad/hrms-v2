                                    ...
                                    <div class="alert alert-primary border border-primary mb-0 p-3">
                                        <div class="d-flex align-items-start">
                                            <div class="text-primary w-100">
                                                ...
                                                <div class="fw-semibold d-flex justify-content-between text-card-size-fixed">Leave Application List</div>
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div class="fs-12 op-8 mb-1 text-card-size-fixed fixed-12"></div>
                                                    <div class="fs-12">
                                                        <a href="{{ url('leaveapprover/leave-request') }}" class="text-primary fw-semibold">
