                            ...
                            <tbody>
                                @foreach($applications as $application)
                                    <tr>
                                        ...
                                        <td>
                                            @if($application->apply_date instanceof \Carbon\Carbon)
                                                {{ $application->apply_date->format('d M Y H:i') }}
                                            @else
                                                {{ \Carbon\Carbon::parse($application->apply_date)->format('d M Y H:i') }}
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="badge badge-{{ $application->status ? 'success' : 'secondary' }}">
