...
@section('title', \App\Helpers\Helper::cachedTrans('Add Holiday Type'))
@section('content')
      ...
      <div class="row">
         <div class="col-md-12">
            <ul class="breadcrumb">
               ...
               <li class="breadcrumb-item active">{{\App\Helpers\Helper::cachedTrans('Add Holiday Type')}}</li>
            </ul>
            <div class="card custom-card">
               <div class="card-header">
                  <h4 class="card-title"><i class="far fa-user"></i>{{\App\Helpers\Helper::cachedTrans('Add Holiday Type')}}  </h4>
               </div>
               <div class="card-body">
