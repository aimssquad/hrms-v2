...
@section('title', 'Holiday Category List')
@php 
...
<div class="content container-fluid pb-0">
	...
	<div class="page-header">
		<div class="row align-items-center">
			<div class="col">
				<h3 class="page-title">Holiday Category List</h3>
				<ul class="breadcrumb">
		...
		<div class="col-md-12">
            <div class="card custom-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">
                        <i class="far fa-file" aria-hidden="true" style="color:#ffa318;"></i>&nbsp;Holiday Category
                    </h4>
                    <div class="row">
                       <div class="col-auto">
