...
@section('title', \App\Helpers\Helper::cachedTrans('Holiday Category List'))
@php 
...
<div class="content container-fluid pb-0">
	...
	<div class="page-header">
		<div class="row align-items-center">
			<div class="col">
				<h3 class="page-title">{{\App\Helpers\Helper::cachedTrans('Holiday Category List')}}</h3>
				<ul class="breadcrumb">
					...
					<li class="breadcrumb-item active">{{\App\Helpers\Helper::cachedTrans('Category')}}</li>
				</ul>
			</div>
				...
				@if($user_type == 'employee')
                    @foreach($sidebarItems['Holiday Management'] as $rotaItem)
                        @if($rotaItem['submenu_name'] == 'Category' && $rotaItem['can_add'] == 1)
                            <a href="{{url('organization/add-holiday-type')}}" class="btn add-btn"><i class="fa-solid fa-plus"></i> {{\App\Helpers\Helper::cachedTrans('Add Category')}}</a>
                        @endif
                    @endforeach
		...
		<div class="col-md-12">
            <div class="card custom-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">
                        <i class="far fa-file" aria-hidden="true" style="color:#ffa318;"></i>&nbsp;{{\App\Helpers\Helper::cachedTrans('Holiday Category')}} 
                    </h4>
                    <div class="row">
                       <div class="col-auto">
