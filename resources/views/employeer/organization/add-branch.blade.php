...
@section('title', 'Add Branch Location')
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Add Branch Location </li>
            </ul>
        </div>
    </div>
</div>
         ...
         <div class="col-md-12">
            <div class="card custom-card">
               <div class="card-header">
                  <h4 class="card-title"><i class="fa fa-map-marker" style="color:rgb(253, 124, 3)"></i>  Add New Branch Location</h4>
               </div>
               <div class="card-body">
                        ...
                        <div class="col-12 col-lg-12 m-auto">
                            <form action="{{ isset($location) ? url('organization/update-location/'.$location->id) : url('organization/save-location') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-md-3 mb-2">
                                        <div class="form-group">
                                            <label for="radius" class="col-form-label">Organization Radius (Meter)</label>
