...
@section('title', \App\Helpers\Helper::cachedTrans('Division'))
@php 
...
<div class="content container-fluid pb-0">
	...
	<div class="page-header">
		<div class="row align-items-center">
			<div class="col">
				<h3 class="page-title">{{\App\Helpers\Helper::cachedTrans('Division')}}</h3>
				<ul class="breadcrumb">
					...
					<li class="breadcrumb-item active">{{\App\Helpers\Helper::cachedTrans('Division')}} </li>
				</ul>
			</div>
				...
				@if($user_type == 'employee')
                    @foreach($sidebarItems['File Manager'] as $rotaItem)
                        @if($rotaItem['submenu_name'] == 'Division' && $rotaItem['can_add'] == 1)
                            <a href="{{ url('file-management/fileManagment-division-add') }}" class="btn add-btn"><i class="fa-solid fa-plus"></i>{{\App\Helpers\Helper::cachedTrans('Add Division')}}</a>
                        @endif
                    @endforeach
        ...
        <div class="col-md-12">
            <div class="card custom-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">
                        <i class="far fa-file" aria-hidden="true" style="color:#ffa318;"></i>&nbsp;{{\App\Helpers\Helper::cachedTrans('Devision')}} 
                    </h4>
                    <div class="row">
                       <div class="col-auto">
