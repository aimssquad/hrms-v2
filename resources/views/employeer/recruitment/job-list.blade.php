...
@section('title', \App\Helpers\Helper::cachedTrans('Job List'))
@php 
                ...
                @if(isset($sidebarItems['Recruitment']))
                    @foreach($sidebarItems['Recruitment'] as $rotaItem)
                        @if($rotaItem['submenu_name'] == 'Job List' && $rotaItem['can_add'] == 1)
                            <a href="{{ url('org-recruitment/add-job-list') }}" class="btn add-btn"><i class="fa-solid fa-plus"></i> {{\App\Helpers\Helper::cachedTrans("Add Job List")}}</a>
                            @break
                            @endif
                        @endforeach
                    @endif  
		...
		<div class="col-md-12">
            <div class="card custom-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">
                        <i class="far fa-file" aria-hidden="true" style="color:#ffa318;"></i>&nbsp;{{\App\Helpers\Helper::cachedTrans("Job List")}}
                    </h4>
                    <div class="row">
                       <div class="col-auto">
