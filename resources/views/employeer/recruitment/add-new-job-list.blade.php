...
<div class="content container-fluid pb-0">
   ...
   <div class="row">
      <div class="col-md-12">
       ...
       required 
       name="soc" 
       value="{{ isset($_GET['id']) ? ($departments[0]->soc ?? '') : old('soc') }}" 
                                     ...
                                     <div class="form-group">
                                         ...
                                         <select id="dept" class="form-control" name="department">
                                             ...
                                             @foreach($depert as $department)
                                                 <option value="{{ $department->department_name }}" {{ $departments[0]->department == $department->department_name ? 'selected' : '' }}>
