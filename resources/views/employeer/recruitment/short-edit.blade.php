...
@section('title', \App\Helpers\Helper::cachedTrans('Short Listing'))
@section('content')
      ...
      <div class="row align-items-center">
         <div class="col">
            ...
            <ul class="breadcrumb">
               ...
               <li class="breadcrumb-item active">{{\App\Helpers\Helper::cachedTrans('Short Listing')}}</li>
            </ul>
         </div>
      </div>
   </div>
   ...
   <div class="row">
        <div class="card">
            <div class="card-body">
                <div class="row">
                   <div class="col-sm-6">
                       <h3 class="p-2">{{\App\Helpers\Helper::cachedTrans('Job Details')}}</h3>
                        <table class="table table-borderless">
                        <tr>
                            <td width="100px">{{\App\Helpers\Helper::cachedTrans('Job Title')}}:</td>
                            <td>{{$job->job_title}}</td>
                        </tr>
                        <tr>
                            <td>{{\App\Helpers\Helper::cachedTrans('Skill level')}}:</td>
                            <td>{{$job->skill_level}}</td>
                        </tr>
                        <tr>
                            <td>{{\App\Helpers\Helper::cachedTrans('Skill Set')}}:</td>
                            <td>{{$job->skill}}</td>
                        </tr>
                        
                          @if($job->apply!='')
                          <tr>
                            <td>{{\App\Helpers\Helper::cachedTrans('How the candidate applied ?')}}</td>
                            <td>{{ $job->apply }}</td>
                        </tr>
                    @endif
</table>
                   ...
                   <div class="col-sm-6 text-end">
                        <h5>{{\App\Helpers\Helper::cachedTrans('Apply Date')}}:<span class="ms-3 d-inline-block"> <?php
                    ...
                    <div class="col-sm-12">
                       <h3 class="p-2">{{\App\Helpers\Helper::cachedTrans('Candidate Details')}}</h3>
                       <table class="table table-bordered">
                            <tr>
                                <td width="300px">{{\App\Helpers\Helper::cachedTrans('Candidate Name')}}:</td>
                                <td>{{$job->name}}</td>
                            </tr>
                            
                            <tr>
                                 @if($job->dob!='')
                                <td width="300px">{{\App\Helpers\Helper::cachedTrans('Date Of Birth')}}:</td>
                                <td>{{ date('d/m/Y',strtotime($job->dob))}}</td>
                                 @endif
                            </tr>
                            
                             <tr>
                                <td width="300px">{{\App\Helpers\Helper::cachedTrans('Gender')}}:</td>
                                <td>{{$job->gender}}</td>
                            </tr>
                            <tr>
                                <td width="300px">{{\App\Helpers\Helper::cachedTrans('Contact Number')}}:</td>
                                <td>+{{$job->phone}}</td>
                            </tr>
                            <tr>
                                <td width="300px">{{\App\Helpers\Helper::cachedTrans('Email')}}:</td>
                                <td>{{$job->email}}</td>
                            </tr>
                            
                             <tr>
                                <td width="300px">{{\App\Helpers\Helper::cachedTrans('Education Qualification')}}:</td>
                                <td>{{$job->edu}}</td>
                            </tr>
                            
                             <tr>
                                <td width="300px">{{\App\Helpers\Helper::cachedTrans('Current Location / Address')}}:</td>
                                <td>{{$job->location}} @if(!empty($job->zip)) ,{{$job->zip}} @endif</td>
                            </tr>
                           
                        </table>
                        
                         <h3 class="p-2">{{\App\Helpers\Helper::cachedTrans('Organization Details')}}</h3>
                         <table class="table table-bordered">
                            <tr>
                                <td width="300px">{{\App\Helpers\Helper::cachedTrans('Current Organization')}}:</td>
                                <td>{{$job->cur_or}}</td>
                            </tr>
                            
                            <tr>
                                <td width="300px">{{\App\Helpers\Helper::cachedTrans('Current Job Title')}}:</td>
                                <td>{{$job->cur_deg}}</td>
                            </tr>
                            
                              <tr>
                                <td width="300px">{{\App\Helpers\Helper::cachedTrans('Total Year of Experience')}}:</td>
                                <td>{{$job->exp}} Years {{$job->exp_month}} Months</td>
                            </tr>
                            
                            <tr>
                                <td width="300px">{{\App\Helpers\Helper::cachedTrans('Expected Salary')}}:</td>
               ...
               <div class="row form-group" style="padding: 3px 0 15px;">
                  <div class="col-md-6">
                     <div class=" form-group current-stage">
                        <label  class="col-form-label">{{\App\Helpers\Helper::cachedTrans('Are  there suitable settled workers available to be recruited for this role ?')}}</label>
               ...
               <div class="row form-group">
                  ...
                  {{-- <div id="remove"> --}}
                     <div class="col-md-4 remove">
                        <div class="form-group" style="margin: 7px 0 15px;">
                           <label class="col-form-label">{{\App\Helpers\Helper::cachedTrans('From Time')}} </label>	
                     ...
                     <div class="col-md-4 remove">
                        <div class="form-group" style="margin: 7px 0 15px;">
                           <label class="col-form-label">{{\App\Helpers\Helper::cachedTrans('To Time')}} </label>	
                     ...
                     <div class="col-md-6 remove">
                        <div class=" form-group" style="margin: 7px 0 15px;">
                           <label  class="col-form-label">{{\App\Helpers\Helper::cachedTrans('Interview Place')}}</label>
                     ...
                     <div class="col-md-6 remove" >
                        <div class=" form-group" style="margin: 7px 0 15px;">
                           <label  class="col-form-label">{{\App\Helpers\Helper::cachedTrans('Interview Panel')}}</label>
