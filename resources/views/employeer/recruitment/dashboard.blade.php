...
@section('title', \App\Helpers\Helper::cachedTrans('Recruitment Dashboard'))
@section('css')
    <style>
...
<div class="content container-fluid pb-0">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">{{\App\Helpers\Helper::cachedTrans("Recruitment Dashboard")}}</h3>
                <ul class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('organization/employerdashboard') }}">{{\App\Helpers\Helper::cachedTrans("Home")}}</a></li>
                    <li class="breadcrumb-item active">{{\App\Helpers\Helper::cachedTrans("Recruitment Dashboard")}}</li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <a href="{{url('recruitment/job_list')}}">
                <div class="profile-widget modern-card">
                    <div class="position-relative z-1">
                        ...
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis">{{\App\Helpers\Helper::cachedTrans("Job List")}}</h4>
            ...
            <a href="{{ url('recruitment/job_posting') }}">
                <div class="profile-widget modern-card">
                    <div class="position-relative z-1">
                        ...
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis">{{\App\Helpers\Helper::cachedTrans("Job Posting")}}</h4>
            ...
            <a href="{{ url('recruitment/job_published') }}">
                <div class="profile-widget modern-card">
                    <div class="position-relative z-1">
                        ...
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis">{{\App\Helpers\Helper::cachedTrans("Job Posting (External)")}}</h4>
            ...
            <a href="{{ url('org-recruitment/candidate') }}">
                <div class="profile-widget modern-card">
                    <div class="position-relative z-1">
                        ...
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis">{{\App\Helpers\Helper::cachedTrans("Job Applied")}}</h4>
            ...
            <a href="{{ url('org-recruitment/short-listing') }}">
                <div class="profile-widget modern-card">
                    <div class="position-relative z-1">
                        ...
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis">{{\App\Helpers\Helper::cachedTrans("Shortlisted")}}</h4>
            ...
            <a href="{{ url('org-recruitment/interview') }}">
                <div class="profile-widget modern-card">
                    <div class="position-relative z-1">
                        ...
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis">{{\App\Helpers\Helper::cachedTrans("Interview")}}</h4>
            ...
            <a href="{{ url('org-recruitment/hired') }}">
                <div class="profile-widget modern-card">
                    <div class="position-relative z-1">
                        ...
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis">{{\App\Helpers\Helper::cachedTrans("Hired")}}</h4>
            ...
            <a href="{{ url('org-recruitment/offer-letter') }}">
                <div class="profile-widget modern-card">
                    <div class="position-relative z-1">
                        ...
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis">{{\App\Helpers\Helper::cachedTrans("Offer Letter")}}</h4>
            ...
            <a href="{{ url('org-recruitment/search') }}">
                <div class="profile-widget modern-card">
                    <div class="position-relative z-1">
                        ...
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis">{{\App\Helpers\Helper::cachedTrans("Search")}}</h4>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="{{ url('org-recruitment/status-search') }}">
                <div class="profile-widget modern-card">
                    <div class="position-relative z-1">
                        ...
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis">{{\App\Helpers\Helper::cachedTrans("Status Search")}}</h4>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a href="{{ url('org-recruitment/reject') }}">
                <div class="profile-widget modern-card">
                    <div class="position-relative z-1">
                        ...
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis">{{\App\Helpers\Helper::cachedTrans("Rejected")}}</h4>
            ...
            <a href="{{ url('org-recruitment/reject') }}">
                <div class="profile-widget modern-card">
                    <div class="position-relative z-1">
                        ...
                        <h4 class="user-name m-t-10 mb-0 text-ellipsis">{{\App\Helpers\Helper::cachedTrans("Message Center")}}</h4>
