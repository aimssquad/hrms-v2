...
<div class="content container-fluid pb-0">
   ...
   <div class="page-header">
      <div class="row align-items-center">
         <div class="col">
            <h3 class="page-title">{{\App\Helpers\Helper::cachedTrans('Hired Details')}}</h3>
            <ul class="breadcrumb">
               ...
               <li class="breadcrumb-item active">{{\App\Helpers\Helper::cachedTrans('Hired Details')}}</li>
            </ul>
         </div>
      </div>
   </div>
         ...
         <div class="card-body">
            <form action="#" method="post" enctype="multipart/form-data">
               ...
               <div class="row form-group">
                  ...
                  <div class="col-md-4">
                     <div class="app-form-text">
                        <h5>{{\App\Helpers\Helper::cachedTrans('Current Job Title')}}:<span>{{$job->cur_deg}}</span></h5>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="app-form-text">
                  ...
                  <div class="col-md-4">
                     <div class="app-form-text">
                        <h5>{{\App\Helpers\Helper::cachedTrans('Expected Salary')}}:<span>@if($job->sal!='') {{ number_format($job->exp_sal,2)}}  @endif</span></h5>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="app-form-text">
                  ...
                  <div class="col-md-4">
                     ...
                     <button class="btn btn-success download" type="button" style="    margin: 11px 0 0;"><a href="{{asset('storage/app/public/'.$job->upload_sh)}}" download target="blank">{{\App\Helpers\Helper::cachedTrans('Download Interview Sheet')}}</a></button>
                     <?php
                        }
