          ...
          <div class="row">
             <div class="col-md-12">
                <div class="card">
                   ...
                   <div class="card-body">
                      <form name="basicform" id="basicform" method="post" action="{{ url('org-edit-right-works') }}" >
                         ...
                         <div id="sf3" class="frm" style="display: none;">
                            {{-- <fieldset> --}}
                               ...
                               <p>You must check that the documents are genuine and that the person presenting them is the prospective
                                  employee or employee, the rightful holder and allowed to do the type of work you are offering.
                               </p>
                               <div class="row form-group">
                                  <div class="col-lg-12">
                         ...
                         <div id="sf4" class="frm" style="display: none;">
                            {{-- <fieldset> --}}
                               ...
                               <p>You must make a clear copy of each document in a format which cannot later be altered, and retain the copy securely:
                                  electronically or in hardcopy. You must copy and retain:
                               </p>
                               <div class="row form-group">
                                  <div class="col-lg-12">
                                     <div class="form-check-inline">
