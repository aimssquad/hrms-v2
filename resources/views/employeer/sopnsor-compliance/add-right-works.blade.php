      ...
      <div class="page-inner">
         <div class="page-header">
            ...
            <ul class="breadcrumbs">
               ...
               <li class="nav-item">
                  <a href="{{ url('org-dashboard-right-works') }}">Right to Work checks List
                  </a>
               </li>
            </ul>
         </div>
         <div class="row">
            <div class="col-md-12">
               <div class="card">
                  ...
                  <div class="card-body">
                     <form name="basicform" id="basicform" method="post" action="{{ url('org-add-right-works') }}" enctype="multipart/form-data" >
                           ...
                           <fieldset>
                              ...
                              <div class="row form-group">
                                 <div class="col-md-6">
                                    ...
                                    <select class="select"  id="employee_idnew" name="employee_idnew" required  disabled >
                              ...
                              <div class="row form-group">
                                 <div class="col-md-12">
                                    ...
                                    <div class="form-check-inline">
                                       ...
                                       <input type="checkbox" class="form-check-input" id="initialCheck" name="type[]" value="Initial check for new employee/applicant - required before employment" checked>Initial check before employment
                                       </label>
                                    </div>
                                    <div class="form-check-inline">
                                       <label class="form-check-label">
                                       <input type="checkbox" class="form-check-input" id="followUpCheck" name="type[]" value="Follow-up check on an existing employee - required before permission to work    expires (under List B - Group 1 or 2)" >Follow-up check on an employee
                                       </label>
                                    </div>
                                 </div>
                              </div>
                        ...
                        <div id="sf2" class="frm" style="display: none;">
                           ...
                           <fieldset>
                              --}}
                              <legend style="color: #ffa704;font-size: 20px;">Step1 for physical check</legend>
                              ...
                              <h3 style="background: #ffaf02;color: #fff;padding: 5px 20px;">List A</h3>
                              <div class="row form-group">
                                 <div class="col-md-12">
                                    <div class="form-check-inline">
                                       <label class="form-check-label">
                              ...
                              <h3 style="background: #fd9103;color: #fff;padding: 5px 20px;">List B Group 1</h3>
                              <div class="row form-group">
                                 <div class="col-md-12">
                                    <div class="form-check-inline">
                                       <label class="form-check-label">
                              ...
                              <h3 style="background: #fca402;color: #fff;padding: 5px 20px;">List B Group 2</h3>
                              <div class="row form-group">
                                 <div class="col-lg-12">
                                    <div class="form-check-inline">
                                       <label class="form-check-label">
