...
@section('title', \App\Helpers\Helper::cachedTrans('Department Wise Employee Roster'))
@section('content')
<div class="content container-fluid pb-0">
   <div class="page-header">
      <div class="row align-items-center">
         <div class="col">
            <h3 class="page-title">{{\App\Helpers\Helper::cachedTrans('Add Department Wise Employee Roster')}}</h3>
            <ul class="breadcrumb">
               ...
               <li class="breadcrumb-item active">{{\App\Helpers\Helper::cachedTrans('Add Department Wise Employee Roster')}} </li>
            </ul>
         </div>
      </div>
   </div>
