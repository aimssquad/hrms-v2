...
@section('title', \App\Helpers\Helper::cachedTrans('Edit Shift Planning'))
@else
@section('title', \App\Helpers\Helper::cachedTrans('Add Shift Planning'))
@endif
@section('content')
<div class="content container-fluid pb-0">
   <div class="page-header">
      <div class="row align-items-center">
         <div class="col">
            @if(app('request')->input('id'))
            <h3 class="page-title">{{\App\Helpers\Helper::cachedTrans('Edit Shift Planning')}}</h3>
            @else
            <h3 class="page-title">{{\App\Helpers\Helper::cachedTrans('Add New Shift Planning')}}</h3>
            @endif
            <ul class="breadcrumb">
               ...
               @if(app('request')->input('id'))
               <li class="breadcrumb-item active">{{\App\Helpers\Helper::cachedTrans('Edit Shift Planning')}}</li>
               @else
               <li class="breadcrumb-item active">{{\App\Helpers\Helper::cachedTrans('Add New Shift Planning')}}</li>
               @endif
            </ul>
         </div>
      </div>
            ...
            <div class="card-body">
               ...
               <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <div class="row form-group">
                     <div class="col-md-3">
                        <div class=" form-group">	
                           <label for="inputFloatingLabel-shift-in-time" class="col-form-label">{{\App\Helpers\Helper::cachedTrans('Work In Time')}}</label>
                     ...
                     <div class="col-md-3">
                        <div class=" form-group">	
                           <label for="inputFloatingLabel-shift-out-time" class="col-form-label">{{\App\Helpers\Helper::cachedTrans('Work Out Time')}}</label>
                     ...
                     <div class="col-md-3">
                        <div class=" form-group">	
                           <label for="inputFloatingLabel-recess-from-time" class="col-form-label">{{\App\Helpers\Helper::cachedTrans('Break Time From')}} </label>
                     ...
                     <div class="col-md-3">
                        <div class=" form-group">	
                           <label for="inputFloatingLabel-recess-to-time" class="col-form-label">{{\App\Helpers\Helper::cachedTrans('Break Time To')}} </label>
                  ...
                  <div class="row form-group">
                     <div class="col-md-6">
                        <div class=" form-group">	
                           <label for="inputFloatingLabel-shift-description" class="col-form-label">{{\App\Helpers\Helper::cachedTrans('Shift Description')}}</label>
