                     ...
                     <tbody>
                        ...
                        <tr>
                           <td style="text-align:center" id="myInput">
                              <a href=" https://skilledworkerscloud.co.uk/hrms-v2/visitor/{{ base64_encode(Session::get("emid")) }}"target="_blank">
                              https://skilledworkerscloud.co.uk/hrms-v2/visitor/{{ base64_encode(Session::get("emid")) }}
                              </a>
                              <button type="button" class="btn btn-default btn-copy js-tooltip js-copy" data-toggle="tooltip" data-placement="bottom" data-copy="https://skilledworkerscloud.co.uk/hrms-v2/visitor/{{ base64_encode(Session::get("emid")) }}" title="Copy Link">
