...
@section('title', \App\Helpers\Helper::cachedTrans('Edit Leave Allocation'))
@section('content')
<div class="content container-fluid pb-0">
<div class="page-header">
   <div class="row">
      <div class="col-sm-12">
         <h3 class="page-title">{{\App\Helpers\Helper::cachedTrans('Edit Leave Allocation')}}</h3>
         <ul class="breadcrumb">
             <li class="breadcrumb-item"><a href="{{url('organization/employerdashboard')}}">{{\App\Helpers\Helper::cachedTrans('Home')}}</a></li>
                <li class="breadcrumb-item"><a href="{{url('leave/dashboard')}}">{{\App\Helpers\Helper::cachedTrans('Dashboard')}}</a></li>
            <li class="breadcrumb-item active">{{\App\Helpers\Helper::cachedTrans('Edit Leave Allocation')}}</li>
         </ul>
      </div>
   </div>
</div>
         ...
         <div class="col-md-12">
            <div class="card custom-card">
               <div class="card-header">
                  <h4 class="card-title"><i class="far fa-user"></i>{{\App\Helpers\Helper::cachedTrans('Edit Leave Allocation')}}</h4>
               </div>
               <div class="card-body">
                        ...
                        <div class="col-12 col-lg-12 m-auto">
                           <form action="{{ url('attendance/save-edit-leave-allocation') }}" method="post" enctype="multipart/form-data">
                              ...
                              <div class="row form-group">
                                 <div class="col-md-4">
                                    <div class="form-group">		
                                       <label for="leave_type_name" class="col-form-label">{{\App\Helpers\Helper::cachedTrans('Leave Type')}}</label>
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">	
                                       <label for="max_no" class="col-form-label">{{\App\Helpers\Helper::cachedTrans('Max No. Of Leave')}} </label>
                              ...
                              <div class="row form-group">
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">	
                                       <label for="leave_in_hand" class="col-form-label">{{\App\Helpers\Helper::cachedTrans('Leave in Hand')}} </label>
                                 ...
                                 <div class="col-md-4">
                                    <div class="form-group">	
                                       <label for="month_yr" class="col-form-label">{{\App\Helpers\Helper::cachedTrans('Effective Year')}}</label>
                              ...
                              <br>
                              <div class="row form-group">
                                 <div class="col-md-12"><button class="btn btn-primary">{{\App\Helpers\Helper::cachedTrans('Submit')}}</button></div>
                              </div>
                           </form>
                        </div>
                     </div>
