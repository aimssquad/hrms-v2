              ...
              <div class="card-body">
                  <form action="{{ url('organization/payment/update/' . $bills->id) }}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="payment_dtl" class="form-label">Payment ID</label>
                                <input type="text" class="form-control" id="payment_dtl" name="payment_dtl" value="{{$bills->payment_dtl}}" required>
                            </div>
                        </div>
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                  ...
                                  <input type="file" class="form-control" id="payment_document" name="payment_document" accept="image/jpeg, image/png">
