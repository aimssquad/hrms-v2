...
@section('title', \App\Helpers\Helper::cachedTrans('Department Master'))
@php 
...
<div class="content container-fluid pb-0">
   ...
   <div class="page-header">
      <div class="row align-items-center">
         <div class="col">
            <h3 class="page-title"> {{\App\Helpers\Helper::cachedTrans('Department Master')}}</h3>
            <ul class="breadcrumb">
               ...
               <li class="breadcrumb-item active">{{\App\Helpers\Helper::cachedTrans('Department Master')}}</li>
            </ul>
         </div>
         <div class="col-auto float-end ms-auto">
            @if($user_type == 'employee')
            @foreach($sidebarItems['Employee Administration'] as $rotaItem)
                  @if($rotaItem['submenu_name'] == 'Department' && $rotaItem['can_add'] == 1)
            <a href="{{ url('org-settings/add-new-department') }}" class="btn add-btn"><i class="fa-solid fa-plus"></i> {{\App\Helpers\Helper::cachedTrans('Add Department')}} </a>
            @endif
            @endforeach
      ...
      <div class="col-md-12">
         <div class="card custom-card">
            <div class="card-header d-flex justify-content-between align-items-center">
               <h4 class="card-title">
                   <i class="far fa-file" aria-hidden="true" style="color:#ffa318;"></i>&nbsp; {{\App\Helpers\Helper::cachedTrans('Department Master')}} 
               </h4>
               <div class="row">
                  <div class="col-auto">
                           ...
                           <td class="text-end">
                              <div class="dropdown dropdown-action">
                                 ...
                                 <div class="dropdown-menu dropdown-menu-right">
                                    @if($user_type == 'employee')
                                    @foreach($sidebarItems['Employee Administration'] as $rotaItem)
														@if($rotaItem['submenu_name'] == 'Department' && $rotaItem['can_edit'] == 1)
