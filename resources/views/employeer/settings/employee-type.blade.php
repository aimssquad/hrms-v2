...
@section('title', 'Type Of Employment')
@php 
   ...
   <div class="page-header">
      <div class="row align-items-center">
         ...
         <div class="col-auto float-end ms-auto">
            ...
            <a href="{{ url('org-settings/employee-type') }}" class="btn add-btn"><i class="fa-solid fa-plus"></i> Add Type Of Employment</a>
            @endif
            {{-- 
      ...
      <div class="col-md-12">
         <div class="card custom-card">
            <div class="card-header d-flex justify-content-between align-items-center">
               <h4 class="card-title">
                   <i class="far fa-file" aria-hidden="true" style="color:#ffa318;"></i>&nbsp;Type Of Employment
               </h4>
               <div class="row">
                  <div class="col-auto">
