...
@section('title', \App\Helpers\Helper::cachedTrans('Add New IFSC'))
@section('content')
         ...
         <div class="row">
            <div class="col-md-12">
               <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">{{\App\Helpers\Helper::cachedTrans('Add IFSC')}}</li>
               </ul>
               <div class="card custom-card">
                  <div class="card-header">
                     <h4 class="card-title"><i class="far fa-user"></i>{{\App\Helpers\Helper::cachedTrans('Add New IFSC')}} </h4>
                  </div>
