...
@section('title', \App\Helpers\Helper::cachedTrans('Mode Of Employee Edit'))
@section('content')
         ...
         <div class="row">
            <div class="col-md-12">
               <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">{{\App\Helpers\Helper::cachedTrans('Edit Mode Of Employee')}}</li>
               </ul>
               <div class="card custom-card">
                  <div class="card-header">
                     <h4 class="card-title"><i class="far fa-user"></i>{{\App\Helpers\Helper::cachedTrans('Edit Mode Of Employee')}} </h4>
                  </div>
                  <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <label for="inputFloatingLabel" class="col-form-label">{{\App\Helpers\Helper::cachedTrans('Mode Of Employee')}} </label>
