                ...
                <table width="600px" cellspacing="0" cellpadding="0" border="0"
                            ...
                            <table style="border-spacing: 0; padding: 0; margin: 0;">
                                <tr>
                                    <td width="25%" style="padding-left: 20px;">
                                        <img src="{{ public_path('storage/'.$org_logo) }}" alt="" width="100%">
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            <p style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; line-height: 1.2; color: #333;">Hello <b>{{ strtoupper("$name") }}</b>,</p>
                    ...
                    <tr>
                        <td style="padding: 0 20px;">
                            <img src="{{ public_path('storage/'.$org_logo) }}" alt="" style="width: 150px;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 0 20px;">
                            <p style="margin: 0 0 20px; font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; font-weight: bold; color: #0044cc;">{{$org_com_name}}</p>
                        </td>
                    </tr>
                            ...
                            <table width="100%" style="border-spacing: 0; padding: 0; margin: 0;">
                                <tr>
                                    ...
                                    <td width="60%" style="background-color: #151831; padding: 0; margin: 0; color: #67839c; text-align: center; height: 50px;border-radius: 16px 0 0 0;">
                                        powered by <a href="#" style="color: #67839c;" target="_blank">{{$org_com_name}}</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
