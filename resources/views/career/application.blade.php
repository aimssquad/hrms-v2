...
<head>
	...
	<link rel="icon" href="{{ asset('https://skilledworkerscloud.co.uk/hrms-v2/frontend/assets/img/swch_logo.png')}}" type="image/x-icon"/>
	<title>SWCH</title>
        	...
        	<div class="container-fluid">
            	<div class="row">
                    ...
                    <div class="col-lg-12">
						...
						<div class="container">
							<div class="row">
								<div class="col-md-12 job-apply bg-white shadow mb-5">
...
@endfor
 ...
 <input type="hidden" class="form-control" name="sal" >
							 ...
							 <div class="col-md-6">
								  ...
								  <div class="row form-group">
								<div class="text-center col-md-12 cv mt-3">
