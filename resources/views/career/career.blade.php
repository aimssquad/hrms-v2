        	...
        	<div class="container-fluid">
            	<div class="row">
                    ...
                    <div class="col-lg-12">
						...
						<div class="container">
							<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 job p-3 bg-white" style="background-image: none!important;">
							<p></p>
							 <ul class="sb large flat no-border blue text-right position-absolute" style="right: 15px; top: 16px;">
									...
									<div class="job-content">
									   <div>
									        ...
									        <tr>
									            ...
									            <td>{{ $job->title}} (Code- {{ $job->job_code}})</td>
									        </tr>
									        <tr>
									            <td>Experience :</td>
									            <td>{{ $job->work_min}} - {{ $job->work_max}} Years</td>
									        </tr>
									    </table>
									   </div>
									    
									    <div class="mt-3">
									        <table class="border border-white td_border">
									        <tr>
									            <td width="300px" style="font-size:18px">Job Description  /  Responsibilities:</td>
									            <td>{!! $job->job_desc !!}</td>
									        </tr>
									    ...
									    <div class="mt-3">
									        <table class="border border-white td_border">
									        <tr>
									            <td width="300px" style="font-size:18px">Educational Qualification:</td>
									            <td>{{ $job->quli}}</td>
									        </tr>
									        @if($job->skill!='')
									        <tr>
									            <td width="300px" style="font-size:18px">Skill Set:</td>
									            <td>{{ $job->skill}}</td>
									        </tr>
									        @endif
									    </table>
									    ...
									    <div class="mt-3">
									        ...
									        <table class="border border-white td_border">
									        <tr>
									            <td width="300px" style="font-size:18px">Gender:</td>
									            <td>{{ $job->gender_male}}<?php if($job->gender!='' && $job->gender_male !=''){ echo ',';}  ?> {{ $job->gender}}</td>
									        </tr>
									     ...
									     <div class="mt-3">
									        <table class="border border-white td_border">
									        <tr>
									            <td width="300px" style="font-size:18px">Job Type:</td>
									            <td>{{ $job->job_type}}</td>
									        </tr>
									    ...
									    <div class="mt-3">
									        <table class="border border-white td_border">
									        <tr>
									            <td width="300px" style="font-size:18px">Working Hours:</td>
									            <td>{{ $job->working_hour}} hours weekly</td>
									        </tr>
									     ...
									     <div class="mt-3">
									        ...
									        <table class="border border-white td_border">
									        <tr>
									            <td width="300px" style="font-size:18px">Language Requirements:</td>
									            <td>@if($job->english_pro!='Others') {{ $job->english_pro}} @else $job->other   @endif</td>
									        </tr>
									    ...
									    <div class="mt-3">
									        ...
									        <table class="border border-white td_border">
									        <tr>
									            <td width="300px" style="font-size:18px">Salary :</td>
									            <td>{{ $job->basic_min}} - {{ $job->basic_max}}    {{ $job->time_pre}}</td>
									        </tr>
