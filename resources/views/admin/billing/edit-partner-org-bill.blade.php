                        ...
                        <div class="col-md-12">
                            <div class="card custom-card">
                                <div class="card-header">
                                    <h4 class="card-title"><i class="far fa-newspaper"></i> Edit Partner Organization Billing</h4>
                                ...
                                <div class="card-body">
                                    <form action="{{ url('partner/bills/update/' . $bills->id) }}" method="post" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="billing_type" class="placeholder">Partner Name</label>
                                                    <input type="hidden" class="form-control" id="billing_type" name="billing_type" value="{{$bills->billing_type}}" readonly>
                                                    @php 
                                                     $org_dtl= DB::table('registration')->where('reg',$bills->entity_id)->get();
                                                     //dd($org_dtl);
                                                     $partner_dtl = DB::table('sub_admin_registrations')->where('org_code',$org_dtl['0']->org_code)->get();
                                                    @endphp
                                                    <input type="text" class="form-control" id="billing_type"  value="{{$partner_dtl['0']->com_name}}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4" id="entity_dropdown">
                                                <div class="form-group">
                                                    <label for="entity_id" class="form-label">Partner Organisation</label>
                                                    <input type="hidden" class="form-control" name="entity_id" value="{{$bills->entity_id}}" readonly>
                                                    <input type="text" class="form-control" value="{{$org_dtl['0']->com_name}}" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="description" class="form-label">Payment Status</label>
                                                    <select class="form-control input-border-bottom" id="" name="status" required>
                                                        ...
                                                        <option value="3" {{ old('status', $bills->status) == '3' ? 'selected' : '' }}>Paid</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
