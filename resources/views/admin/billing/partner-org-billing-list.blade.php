                  ...
                  <div class="col-md-12">
                     <div class="card custom-card">
                        <div class="card-header">
                           <h4 class="card-title">
                              <i class="far fa-building"></i> Invoice Not Issued For Partner Organisation List <span><a href="{{ url('superadmin/partner-not-issued-billing-list') }}" data-toggle="tooltip" data-placement="bottom" title="Show Not Issued List" style="padding: 8px 0;"><img  style="width: 25px;" src="{{ asset('img/work_checks.png')}}"></a></span><br>
                        ...
                        <div class="card-body">
                           <div class="table-responsive">
                              <table id="basic-datatables" class="display table table-striped table-hover" >
                                 {{-- <i class="far fa-list">Invoice Not Issued For Partner Organisation List<a href="{{ url('superadmin/partner-not-issued-billing-list') }}" data-toggle="tooltip" data-placement="bottom" title="Generate Bill" style="padding: 8px 0;"><img  style="width: 25px;" src="{{ asset('img/plus1.png')}}"></a></i> --}}
                                 <h4 class="card-title">
                                    <i class="far fa-building"></i> Partner Organisation Invoice <span><a href="{{ url('superadmin/partner-org-billing') }}" data-toggle="tooltip" data-placement="bottom" title="Create Invoice" style="padding: 8px 0;"><img  style="width: 25px;" src="{{ asset('img/plus1.png')}}"></a></span><br>   
                                 </h4>
                                <thead>
                                    <tr>
                                       <th>Sl.No.</th>
                                       ...
                                       <td class="drp">
                                          <div class="dropdown">
                                             ...
                                             <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="{{ route('partner.billing.edit', $billing->id) }}"><i class="far fa-edit"></i>&nbsp; Edit</a>
