                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card custom-card">
                                ...
                                <div class="card-body">
                                    <form action="{{ url('superadmin/sub/add-hr-support-file-type') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="sub_name" class="form-control input-border-bottom" id="selectFloatingLabel" required value="{{ isset($user) ? $user->type : '' }}">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
