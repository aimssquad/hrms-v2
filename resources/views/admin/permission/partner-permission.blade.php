                     ...
                     <div class="col-md-12">
                        <div class="card custom-card">
                           <div class="card-header">
                              @php
                                 $data = DB::table('sub_admin_registrations')->where('reg',$org_id)->first();
                              @endphp
                              <h2 class="card-title">
                                 <i class="far-fa-building"></i> ( {{$data->com_name}} - {{$data->reg}}) Partner Permission 
                           ...
                           <form action="{{ url('subadmin/partner/savepermission') }}" method="POST">
                              @csrf
                              <input type="hidden" name="partner_id" value="{{$org_id}}">
                                  ...
                                  <table class="table table-striped table-bordered custom-table">
                                      ...
                                      <tbody>
                                          ...
                                          <tr>
                                              ...
                                              {{-- <input type="text" name="module" value="{{$menu->module}}"> --}}
                                              <td>
