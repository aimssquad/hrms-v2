                  ...
                  <div class="col-md-12">
                     <div class="card custom-card">
                        <div class="card-header">
                           <h4 class="card-title"><i class="far fa-user"></i> Hr Support Sub File Types <span><a data-toggle="tooltip" data-placement="bottom" title="Hr Support File Types" href="{{url('superadmin/sub/add-hr-support-file-type')}}"><img  style="width: 25px;" src="{{ asset('img/plus1.png')}}"></a></span></h4>
                           ...
                           <div class="table-responsive">
                              <table id="basic-datatables" class="display table table-striped table-hover" >
                                 ...
                                 <tbody>
                                        ...
                                        <td>{{ $datas->type ? $datas->type->type : 'N/A' }}</td>
                                        <td>
                                            {{$datas->sub_name}}
                                        </td>
                                        @if ($datas->status == 0)
                                        ...
                                        <td class="icon">
                                            <a data-toggle="tooltip" data-placement="bottom"  title="Edit" href="{{url('superadmin/sub/edit-hr-support-file/'.$datas->id)}}"><img  style="width: 14px;" src="{{ asset('assets/img/edit.png')}}"></a>
