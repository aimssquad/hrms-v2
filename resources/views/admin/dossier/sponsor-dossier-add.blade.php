                                 ...
                                 <div class="row">
                                    <div class="col-md-4">
                                       <div class="form-group ">
                                          <label for="selectFloatingLabel3" class="placeholder">Dossier Title</label>		
                                          <input type="text" id="title" name="title"  class="form-control "  required  value="">
                                       </div>
                                    </div>
                                    <div class="col-md-4">
                                       <div class="form-group ">
                                          <label for="selectFloatingLabel3" class="placeholder">Dossier Link</label>		
                                          <input type="text" id="link" name="link"  class="form-control "  required value="">
                                       </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group ">
                                            <label for="selectFloatingimage" class="placeholder">Dossier File  </label>
                                            <input id="dossier_file" type="file" class="form-control "  name="dossier_file"   onchange="Filevalidationproimge()" >
