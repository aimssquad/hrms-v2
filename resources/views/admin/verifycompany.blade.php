                     ...
                     <div class="col-md-12">
                        <div class="card custom-card">
                           <div class="card-header">
                              <h4 class="card-title">
                                 <i class="far-fa-building"></i> WIP Organisation @if(count($companies_rs)!=0)
                                          ...
                                          <td class="drp">
                                             <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
												   ...
												   {{-- <a class="dropdown-item" href="{{url('superadmin/edit-company/'.$company->reg)}}"><i class="fa fa-hand-o-right"></i>&nbsp; permission</a> --}}
