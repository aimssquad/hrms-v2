        ...
        @if($userType=='admin')
         <ul class="nav nav-primary">
            ...
            <li class="nav-item">
               ...
               <div class="collapse" id="sidebarLayoutsubadmin">
                  <ul class="nav nav-collapse">
                     ...
                     <li>
                        <a href="{{url('subadmin/partner-emmployee-count')}}">
            ...
            <li class="nav-item">
               ...
               <div class="collapse" id="sidebarLayoutjstimeassigviewn">
                  <ul class="nav nav-collapse">
                     ...
                     <li>
                        <a href="{{url('superadmin/view-cos')}}">
                           <p> COS File Update </p>
                        </a>
                     </li>
                  </ul>
            ...
            <li class="nav-item">
               ...
               <div class="collapse" id="video_uplode">
                  <ul class="nav nav-collapse">
                     <li>
                        <a href="{{url('superadmin/login_page_file')}}">
                        <span class="sub-item">Login Page File Uplode</span>
                        </a>
                     </li>
                     <li>
                        <a href="{{url('superadmin/registration_page_file')}}">
                        <span class="sub-item">Registration Page File Uplode</span>
                        </a>
                     </li>
                  </ul>
               </div>
