                     ...
                     <div class="col-md-12">
                        <div class="card custom-card">
                           <div class="card-header">
                              <h4 class="card-title"><i class="fas fa-file-word"></i> Login Page Video And Images Uplode</h4>
                           </div>
                           <div class="card-body">
                      <form action="{{ isset($video) ? route('update.video.image', $video->id) : route('upload.video.image') }}" 
      method="POST" 
