                ...
                <table width="600px" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            <p style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; color: #333;"><strong>Dear {{ $offer->emp_fname }} {{ $offer->emp_mname }} {{ $offer->emp_lname }},</strong></p>
                            ...
                            <p style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; color: #333;">Please submit your updated documents regarding your Right-to-Work to the HR team no later
                    ...
                    <tr>
                        <td style="color: #333; font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; padding: 0 20px;">
                    ...
                    <tr>
                        <td style="padding: 0 20px;">
                            <p style="margin: 0 0 20px; font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; font-weight: bold; color: #0044cc;"><strong>{{ $Roledata->com_name }} HR Team</strong></p>
                        </td>
                    </tr>
