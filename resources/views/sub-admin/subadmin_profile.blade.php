...
<div class="content container-fluid pb-0">
   ...
   <div class="page-header">
      <div class="row">
         <div class="col-sm-12">
            <h3 class="page-title">Partner Profile</h3>
            <ul class="breadcrumb">
                        ...
                        <div class="col-md-6">
                           <div class="profile-info-left">
                              ...
                              <div class="staff-msg">
                                 ...
                                 <a class="btn btn-custom" href="{{ url('subadmin/edit/profile/' . $companies_rs->id) }}"><i class="fa-solid fa-pencil"></i>Edit Profile</a>
                              </div>
                           </div>
                        </div>
                        <div class="col-md-6">
