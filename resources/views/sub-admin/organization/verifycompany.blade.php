...
<div class="content container-fluid pb-0">
    ...
    <div class="page-header">
        <div class="row align-items-center">
           <div class="col">
              <h3 class="page-title">Approved Organisation</h3>
              <ul class="breadcrumb">
                 ...
                 <li class="breadcrumb-item active">Approved Organisation</li>
              </ul>
           </div>
        </div>
     </div>
         ...
         <div class="col-md-12">
            <div class="card custom-card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">
                        <i class="fa fa-check" aria-hidden="true" style="color:#ffa318;"></i>&nbsp;Registered Approved Organisation
                    </h4>
                    <div class="row">
                       <div class="col-auto">
