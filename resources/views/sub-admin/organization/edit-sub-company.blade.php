...
<div class="content container-fluid pb-0">
    ...
    <div class="page-header">
        <div class="row align-items-center">
           <div class="col">
              <h3 class="page-title">Registered Partner</h3>
              <ul class="breadcrumb">
                    ...
                    <div class="card-body" style="">
                        <form action="{{url('subadmin/editsub-child-company')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                               <div class="col-md-4">
                                  <div class="form-group ">
                                     <label for="inputFloatingLabel" class="col-form-label">Organisation Name</label>
                                     <input id="inputFloatingLabel" type="text" class="form-control "  readonly  name="com_name"  value="{{ $Roledata->com_name}}">
                                  </div>
                               </div>
                               <div class="col-md-4">
                                  <div class="form-group ">
                                     <label for="selectFloatingLabel" class="col-form-label">Type of Organisation </label>
                            ...
                            <div class="row">
                               <div class="col-md-4">
                                  <div class="form-group ">
                                     <label for="inputFloatingLabel4" class="col-form-label">Contact No.</label>
                                     <input id="inputFloatingLabel4" type="text" class="form-control"  readonly name="p_no"  value="{{  $Roledata->p_no }}">
                                  </div>
                               </div>
                               <div class="col-md-4">
                                  <div class="form-group">
                                     <label for="inputFloatingLabel3" class="col-form-label">Login Email ID</label>
                            ...
                            <div class="row ">
                               <div class="col-md-4">
                                  <div class="form-group ">
                                     <label for="trad_name" class="col-form-label">Trading Name</label>
                               ...
                               <div class="col-md-4">
                                  <div class="form-group ">
                                     <label for="inputFloatingLabel9" class="col-form-label">Trading Period</label>
                                     <input type="text" class="form-control " name="com_year"   readonly value="{{$Roledata->com_year}}" >
                                  </div>
                               </div>
                               <div class="col-md-4">
                                  <div class="form-group ">
                                     <label for="selectFloatingLabel1" class="col-form-label">Name Of Sector</label>
                               ...
                               <div class="col-md-6">
                                  <div class="form-group ">
                                     <label for="trad_status" class="col-form-label">Have you changed Organisation /Trading  name in last 5 years?    <span class="star">(*)</label>
                            ...
                            <div class="row">
                               <div class="col-md-3">
                                  <div class="form-group ">
                                     <label for="inputFloatingLabel15" class="col-form-label">Address Line 1</label>
                               ...
                               <div class="col-md-3">
                                  <div class="form-group ">
                                     <label for="zip" class="col-form-label">Post Code</label>
                                     <input id="zip" type="text" class="form-control "  name="zip" readonly  value="@if($Roledata->zip){{  $Roledata->zip }}@endif">
                                  </div>
                               </div>
                               <div class="col-md-3">
                                  <div class="form-group ">
                                     <label for="selectFloatingLabel" class="col-form-label">Country</label>
                            ...
                            <div class="row">
                               <div class="col-md-3">
                                  <div class="form-group">
                                     ...
                                     <input type="text" class="form-control mb-2" id="day2"  value="Monday" readonly>
                                  </div>
                               </div>
                               <div class="col-md-3">
                                  <div class="form-group ">
                                     <label for="mon_status" class="col-form-label">Status</label>
                                     <input type="text" class="form-control mb-2" id="mon_status"  value="{{$Roledata->mon_status}}" readonly>
                                  </div>
                               </div>
                            ...
                            <div class="row">
                               <div class="col-md-3">
                                  <div class="form-group">
                                     <input type="text" class="form-control mb-2" id="day3"  value="Tuesday" readonly>
                                  </div>
                               </div>
                               <div class="col-md-3">
                                  <div class="form-group ">
                            ...
                            <div class="row">
                               <div class="col-md-3">
                                  <div class="form-group">
                                     <input type="text" class="form-control mb-2" id="day3"  value="Wednesday" readonly>
                                  </div>
                               </div>
                               <div class="col-md-3">
                                  <div class="form-group ">
                            ...
                            <div class="row">
                               <div class="col-md-3">
                                  <div class="form-group">
                                     <input type="text" class="form-control mb-2" id="day3"  value="Thursday" readonly>
                                  </div>
                               </div>
                               <div class="col-md-3">
                                  <div class="form-group ">
                            ...
                            <div class="row">
                               <div class="col-md-3">
                                  <div class="form-group">
                                     <input type="text" class="form-control mb-2" id="day3"  value="Friday" readonly>
                                  </div>
                               </div>
                               <div class="col-md-3">
                                  <div class="form-group ">
                            ...
                            <div class="row">
                               <div class="col-md-3">
                                  <div class="form-group">
                                     <input type="text" class="form-control mb-2" id="day3"  value="Saturday" readonly>
                                  </div>
                               </div>
                               <div class="col-md-3">
                                  <div class="form-group ">
                            ...
                            <div class="row">
                               <div class="col-md-3">
                                  <div class="form-group">
                                     <input type="text" class="form-control mb-2" id="day1"  value="Sunday" readonly>
                                  </div>
                               </div>
                               <div class="col-md-3">
                                  <div class="form-group ">
                            ...
                            <div class="row form-group" id="dvInactiveRemarks" style="display:none;">
                               <div class="col-md-12">
                                  <div class="form-group ">
                                     <label for="licence" class="col-form-label">Reason (Inactive)</label>
