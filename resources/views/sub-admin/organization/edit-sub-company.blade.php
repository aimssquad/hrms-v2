              ...
              <div class="col-md-12">
                 <div class="card custom-card">
                    ...
                    <div class="card-body" style="">
                       <form action="{{url('subadmin/editsub-child-company')}}" method="post" enctype="multipart/form-data">
                          {{csrf_field()}}
                          <input  type="hidden" class="form-control "   name="reg"  value="{{ $Roledata->reg}}">
                          <div class="row">
                             <div class="col-md-4">
                                <div class="form-group ">
                                   <label for="inputFloatingLabel" >Organisation Name</label>
                                   <input id="inputFloatingLabel" type="text" class="form-control "  readonly  name="com_name"  value="{{ $Roledata->com_name}}">
                                </div>
                             </div>
                             <div class="col-md-4">
                                <div class="form-group ">
                                   <label for="selectFloatingLabel" >Type of Organisation </label>
                             ...
                             <div class="col-md-4 write-type" id="others-type"  <?php if ($Roledata->com_type == 'others-type') {?> style="display:block;" <?php } else {?> style="display:none;" <?php }?>>
                                <div class="form-group ">
                                   <label for="inputFloatingLabel8" >Type Name</label>
                             ...
                             <div class="col-md-4">
                                <div class="form-group ">
                                   <label for="inputFloatingLabel7" > Registration No.</label>
                          ...
                          <div class="row">
                             <div class="col-md-4">
                                <div class="form-group ">
                                   <label for="inputFloatingLabel4" >Contact No.</label>
                                   <input id="inputFloatingLabel4" type="text" class="form-control"  readonly name="p_no"  value="{{  $Roledata->p_no }}">
                                </div>
                             </div>
                             <div class="col-md-4">
                                <div class="form-group">
                                   <label for="inputFloatingLabel3" >Login Email ID</label>
                             ...
                             <div class="col-md-4">
                                <div class="form-group">
                                   <label for="inputFloatingLabel3" >Organisation Email ID  <span class="star">(*)</label>
                                   <input id="organ_email" type="text" class="form-control " readonly required="" name="organ_email"  value="{{  $Roledata->organ_email }}">
                                </div>
                             </div>
                             <div class="col-md-4">
                                <div class="form-group">
                                   <label for="inputFloatingLabel5" >Website</label>
                          ...
                          <div class="row ">
                             <div class="col-md-4">
                                <div class="form-group ">
                                   <label for="trad_name" >Trading Name</label>
                             ...
                             <div class="col-md-4">
                                <div class="form-group ">
                                   <label for="inputFloatingLabel9" >Trading Period</label>
                                   <input type="text" class="form-control " name="com_year"   readonly value="{{$Roledata->com_year}}" >
                                </div>
                             </div>
                             <div class="col-md-4">
                                <div class="form-group ">
                                   <label for="selectFloatingLabel1" >Name Of Sector</label>
                             ...
                             <div class="col-md-4 Other-service-activities" id="Other-service-activities" <?php if ($Roledata->com_nat == 'Other service activities') {?> style="display:block;" <?php } else {?> style="display:none;" <?php }?>>
                                <div class="form-group ">
                                   <label for="inputFloatingLabel10" >Name Of Sector</label>
                             ...
                             <div class="col-md-6">
                                <div class="form-group ">
                                   <label for="trad_status" >Have you changed Organisation /Trading  name in last 5 years?    <span class="star">(*)</label>
                             ...
                             <div class="col-md-6 " id="criman_new" <?php if ($Roledata->trad_status == 'Yes') {?> style="display:block;" <?php } else {?> style="display:none;" <?php }?>>
                                <div class="form-group ">
                                   <label for="trad_other" >Give Details</label>
                             ...
                             <div class="col-md-6">
                                <div class="form-group ">
                                   <label for="penlty_status" >Did your organisation faced penalty (e.g., recruiting illegal employee) in last  3 years?    <span class="star">(*)</label>
                             ...
                             <div class="col-md-6 " id="criman_penlty_new" <?php if ($Roledata->penlty_status == 'Yes') {?> style="display:block;" <?php } else {?> style="display:none;" <?php }?>>
                                <div class="form-group ">
                                   <label for="penlty_other" >Give Details</label>
                          ...
                          <div class="row">
                             ...
                             <div class="col-md-6">
                                <div class="form-group ">
                                   <label for="bank_status" >Do you have a history of Criminal conviction/Bankruptcy/Disqualification?    <span class="star">(*)</label>
                             ...
                             <div class="col-md-6 " id="criman_bank_new" <?php if ($Roledata->bank_status == 'Yes') {?> style="display:block;" <?php } else {?> style="display:none;" <?php }?>>
                                <div class="form-group ">
                                   <label for="bank_other" >Give Details </label>
                          ...
                          <div class="row">
                             ...
                             <div class="col-md-6">
                                <div class="form-group ">
                                   <label for="key_bank_status" >Do you have a history of Criminal conviction/Bankruptcy/Disqualification?    <span class="star">(*)</label>
                          ...
                          <div class="row">
                             ...
                             <div class="col-md-6">
                                <div class="form-group ">
                                   <label for="level_bank_status" >Do you have a history of Criminal conviction/Bankruptcy/Disqualification?    <span class="star">(*)</label>
                             ...
                             <div class="col-md-6 " id="criman_level_bank_new" <?php if ($Roledata->level_bank_status == 'Yes') {?> style="display:block;" <?php } else {?> style="display:none;" <?php }?>>
                                <div class="form-group ">
                                   <label for="level_bank_other" >Give Details </label>
                          ...
                          <div class="row">
                             <div class="col-md-3">
                                <div class="form-group ">
                                   <label for="inputFloatingLabel15" >Address Line 1</label>
                             ...
                             <div class="col-md-3">
                                <div class="form-group ">
                                   <label for="road" >Address Line 3</label>
                             ...
                             <div class="col-md-3">
                                <div class="form-group ">
                                   <label for="selectFloatingLabel" >Country</label>
                          ...
                          <div class="row">
                             <div class="col-md-3">
                                <div class="form-group ">
                                   @if($truplouii_id==1)
                                   <label for="name<?=$truplouii_id?>" >Full Name</label>
                                   @endif
                             ...
                             <div class="col-md-2">
                                <div class="form-group ">
                                   @if($truplouii_id==1)
                                   <label for="department<?=$truplouii_id?>" >Department</label>
                                   @endif
                             ...
                             <div class="col-md-2">
                                <div class="form-group ">
                                   @if($truplouii_id==1)
                                   <label for="job_type<?=$truplouii_id?>" >Job Type</label>
                                   @endif
                             ...
                             <div class="col-md-2">
                                <div class="form-group ">
                                   @if($truplouii_id==1)
                                   <label for="designation<?=$truplouii_id?>" >Job Title</label>
                                   @endif
                             ...
                             <div class="col-md-3">
                                <div class="form-group ">
                                   @if($truplouii_id==1)
                                   <label for="immigration<?=$truplouii_id?>" >Immigration Status
                                   </label>
                                   @endif
                          ...
                          <div class="row">
                             ...
                             <div class="col-md-3 " id="mon_status_close" >
                                <div class="form-group ">
                                   <label for="mon_close" >Closing Time</label>
                          ...
                          <div class="row form-group">
                             <div class="col-md-3">
                                <div class="form-group ">
                                   <label for="selectFloatingLabel3" >Status</label>
                             ...
                             <div class="col-md-3">
                                <div class="form-group">
                                   <label for="verify" >Verification123</label>
                             ...
                             <div class="col-md-3">
                                <div class="form-group ">
                                   <label for="licence" >License Applied</label>
                          ...
                          <div class="row form-group" id="dvInactiveRemarks" style="display:none;">
                             <div class="col-md-12">
                                <div class="form-group ">
                                   <label for="licence" >Reason (Inactive)</label>
