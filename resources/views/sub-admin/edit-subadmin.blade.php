              ...
              <div class="col-md-12">
                 <div class="card custom-card">
                    ...
                    <div class="card-body" style="">
                     <form action="{{url('subadmin/update/profile')}}" method="post" enctype="multipart/form-data" onsubmit="return validateForm();">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-3 mb-2 write-type" id="others-type"  <?php if ($Roledata->com_type == 'others-type') {?> style="display:block;" <?php } else {?> style="display:none;" <?php }?>>
                              <div class="form-group">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6 mb-2">
                              <div class="form-group">
                                 ...
                                 <select class="select w-100" id="selectFloatingLabel1" name="com_nat">
                                    <option value="">&nbsp;</option>
                           ...
                           <div class="col-md-6 mb-2 Other-service-activities" id="Other-service-activities" <?php if ($Roledata->com_nat == 'Other service activities') {?> style="display:block;" <?php } else {?> style="display:none;" <?php }?>>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6 mb-2" id="criman_key_bank_new" <?php if ($Roledata->key_bank_status == 'Yes') {?> style="display:block;" <?php } else {?> style="display:none;" <?php }?>>
                              <div class="form-group">
