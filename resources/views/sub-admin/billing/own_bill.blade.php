...
@section('title', ' Subscription Invoice List')
@section('content')
<!-- Page Content -->
                       ...
                       @foreach($bill_list as $billing)
                        <tr>
                           ...
                           <td>
                               ...
                               @if($billing->status == 1) <span class="badge bg-inverse-danger">Not Paid</span> @elseif($billing->status == 2) <span class="badge bg-inverse-info">Pending</span> @else <span class="badge bg-inverse-success">Paid</span> @endif
                           </td>
                            <td class="text-end">
