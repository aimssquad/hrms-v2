                ...
                <table width="600px" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            ...
                            <p style="font-size: 16px; color: #333;">Date : {{date('d/m/Y',strtotime($offer->euss_exp_date.'  - 90  days'))}}</p>
                            <p style="font-size: 16px; color: #333;"><b>Subject: Right to Work Documentation – Temporary Passport 90-day Reminder.</b></p>
