   ...
   <body>
         ...
         <tbody>
            ...
            <tr>
               ...
               <td style="background: #edf0f6;padding: 8px;">
                  ...
                  <div>
                    <?php  if(in_array("Share Code", $timearray)){?>
                    <img src="<?=env("BASE_URL");?>public/img/radio-check.png" alt=""> <?php }else{ ?>
                    <img src="<?=env("BASE_URL");?>public/img/radio-uncheck.png" alt="">  <?php }
                       ?>
     ...
     @if($work_rs->medium === "Share Code")
      ...
      <table  class="rtw-form-view"  border="1" style="margin-bottom:10px !important;border-collapse:collapse;max-width: 900px;width:100%;
        ...
        <tr>
          <td style="width: 200px; padding: 8px; background: #bbe1f8;font-weight: 600;">Share Code Referance No:</td>
          <td style="background: #edf0f6;padding: 8px;">{{ $work_rs->share_referance_no }}</td>
        </tr> 
        <tr>
          <td style="width: 200px; padding: 8px; background: #bbe1f8;font-weight: 600;">Share Code Use By:</td>
          <td style="background: #edf0f6;padding: 8px;">{{ $work_rs->share_code_used_by }}</td>
        </tr> 
        <tr>
          <td style="width: 200px; padding: 8px; background: #bbe1f8;font-weight: 600;">Company Name:</td>
          <td style="background: #edf0f6;padding: 8px;">{{ $work_rs->share_com_name }}</td>
        </tr> 
        <tr>
          <td style="width: 200px; padding: 8px; background: #bbe1f8;font-weight: 600;">Date of Check:</td>
          <td style="background: #edf0f6;padding: 8px;">{{ \Carbon\Carbon::parse($work_rs->share_date_check)->format('d-m-Y') }}</td>
        </tr> 
        <tr>
          <td style="width: 200px; padding: 8px; background: #bbe1f8;font-weight: 600;">Permission To Work From:</td>
          <td style="background: #edf0f6;padding: 8px;">{{ \Carbon\Carbon::parse($work_rs->share_permission_form)->format('d-m-Y') }}</td>
        </tr>
        <tr>
          <td style="width: 200px; padding: 8px; background: #bbe1f8;font-weight: 600;">Permission To Work Expiry:</td>
          <td style="background: #edf0f6;padding: 8px;">{{ \Carbon\Carbon::parse($work_rs->share_permission_expiry)->format('d-m-Y') }}</td>
        </tr>
        <tr>
          <td style="width: 200px; padding: 8px; background: #bbe1f8;font-weight: 600;">Remarks:</td>
          <td style="background: #edf0f6;padding: 8px;">{{ $work_rs->share_remarks }}</td>
        </tr>
        <tr>
          <td style="width: 200px; padding: 8px; background: #bbe1f8;font-weight: 600;">Uploaded Documents:</td>
          <td style="background: #edf0f6;padding: 8px;">
               @php
                  $documents = json_decode($work_rs->share_doc, true); // Decode JSON
               @endphp
            
               @if(!empty($documents) && is_array($documents))
                  @foreach($documents as $document)
                     <a href="{{ asset('storage/uploads/share-code/' . $document) }}" target="_blank">{{ $document }}</a><br>
                  @endforeach
               @else
        ...
        <tr>
         <td style="width: 200px; padding: 8px; background: #bbe1f8;font-weight: 600;">If you employ this person you must:</td>
         <td style="background: #edf0f6;padding: 8px;">
            <input type="checkbox" {{ $work_rs->share_phically ? 'checked' : '' }} disabled>Check this look like the person you meet face to face or by video call <br>
            <input type="checkbox" {{ $work_rs->share_hardcopy ? 'checked' : '' }} disabled>Keep a secure copy of this online check(either electronicaly or hand copy), for duretion of the employment and for 2 years after
         </td>
        </tr>
      </table>   
     @else
      ...
      <table border="1" class="rtw-form-view" style="margin-bottom: :10px !important;border-collapse:collapse;max-width: 900px;
         ...
         <tr>
            <td style="padding: 5px;">If you have correctly carried out the above 3 steps you will have an excuse against
               ...
               determines how long it lasts for, and if, and when you are required to do a followup check.</br>The documents that you have checked and copied are from:</p>
            </td>
         </tr>
         <?php 
            $timearray=array();
         ...
         <tr>
            <td style="padding: 5px;">
               <div class="excuselist" style="padding-left:0;">
                  <label> 2.   <b>List B: Group 1 </b></label>  
               </div>
               <div class="excuselist">
         ...
         <tr>
            <td style="padding: 5px;">
               <div class="excuselist" style="padding-left:0;">
                  <label> 3.   <b>List B: Group 2 </b></label> 
               </div>
               <div class="excuselist">
               ...
               <div class="text-center rtw-scan" style="font-family: calibri;padding-left: 0;">
                  ...
                  <div class="scan-body" style="background: #f0f6f9;padding-left: 0;">
                     <?php
                        ...
                        ?>
                     <embed src="<?=env("BASE_URL");?>public/{{$secod[0]}}" frameborder="0" width="50%" height="auto" style="text-align:center;">
                     </embed>
                     <?php
                        }else{
                           ?>
                     <embed src="<?=env("BASE_URL");?>public/{{$work_rs->scan_f_img}}" frameborder="0" width="50%" height="auto" style="text-align:center;">
                     </embed>
                     <?php
                        }
                        ?>
               ...
               <div class="text-center rtw-scan" style="font-family: calibri;">
                  ...
                  <div class="scan-body" style="background: #e0f6ff;">
                     ...
                     <?php
                           ...
                           ?>
                     <embed src="<?=env("BASE_URL");?>public/{{$work_rs->scan_s_img}}" frameborder="0" width="50%" height="auto" style="text-align:center;">
                     </embed>
                     <?php
                        }
                        ?>
            ...
            <td>
               ...
               <div class="scan-body" style="background: #ffedcb;">
                  ...
                  <?php
                        ...
                        ?>
                  <embed src="<?=env("BASE_URL");?>public/{{$work_rs->scan_r_img}}" frameborder="0" width="50%" height="auto" style="text-align:center;">
                  </embed>
                  <?php
                     }
                     ?>
