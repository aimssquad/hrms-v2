                ...
                <table width="600px" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            ...
                            <p style="font-size: 16px; color: #333;">{{ $offer->emp_pr_street_no}} @if( $offer->emp_per_village) ,{{ $offer->emp_per_village}} @endif @if( $offer->emp_pr_state) ,{{ $offer->emp_pr_state}} @endif @if( $offer->emp_pr_city) ,{{ $offer->emp_pr_city}} @endif
                                @if( $offer->emp_pr_pincode) ,{{ $offer->emp_pr_pincode}} @endif  @if( $offer->emp_pr_country) ,{{ $offer->emp_pr_country}} @endif
                            </p>

                            <p style="font-size: 16px; color: #333;">Date : {{date('d/m/Y',strtotime($offer->visa_exp_date.'  - 90  days'))}}</p>
                            <p style="font-size: 16px; color: #333;"><b>Subject: Right to Work Documentation – Temporary Visa 90-day Reminder.</b>
                                <p style="font-size: 16px; color: #333;">Further to your employment on a temporary visa, I am writing to remind you that this visa is due to
                                ...
                                <p style="font-size: 16px; color: #333;">Examples of the documents we require are as follows:</p>
                            ...
                            <p style="font-size: 16px; color: #333;">{{ $Roledata->com_name }}  will complete a check with the Home Office Employer Checking Service to
                                ...
                                <p style="font-size: 16px; color: #333;">As previously advised, the immigration, Asylum and the Nationality Act 2006 requires all employers
                                ...
                                {{ $Roledata->com_name }}</p>
                                <p style="font-size: 16px; color: #333;">Please bring your original documents into the HR team without delay or no later than & 15 days of
                                ...
                                <p style="font-size: 16px; color: #333;">Please do not hesitate to contact me if you have any concern or would like to discuss this further.</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td height="20px; " style="padding-left:20px;">{{ $Roledata->f_name }} {{ $Roledata->l_name }}</td>
                    </tr>
