                ...
                <table width="600px" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            ...
                            <p style="font-size: 16px; color: #333;">Date : {{date('d/m/Y',strtotime($offer->euss_exp_date.'  - 30  days'))}}</p>
                            <p style="font-size: 16px; color: #333;"><b>Subject: Right to Work Documentation – Temporary Passport 30-day Reminder.</b></p>
                            <p style="font-size: 16px; color: #333;">Further to your employment on a temporary passport, I am writing to remind you that this passport is due to
                    ...
                    <tr>
                        <td height="20" style="padding-left: 20px;"> {{ $Roledata->f_name }} {{ $Roledata->l_name }}</td>
                    </tr>

                    <tr>
                        <td style="padding: 0 20px;">
                            <p style="margin: 0 0 20px; font-size: 18px; font-weight: bold; color: #0044cc;">{{ $Roledata->desig }}</p>
                        </td>
                    </tr>
