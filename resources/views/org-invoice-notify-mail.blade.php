...
<head>
    ...
    <title>Invoice Notify Email</title>
                ...
                <table width="600px" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            <p style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; line-height: 1.2; color: #333;">Hi <b>{{ strtoupper($p_com_name) }}</b>,</p>
                            <p style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; line-height: 1.2; color: #333;">The below Invoice has been send to <strong>{{$com_name}}.</strong></p>
                            <p style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; line-height: 1.2; color: #333;"><strong>Name :</strong> {{"$f_name $l_name"}}</p>
                            <p style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; line-height: 1.2; color: #333;"><strong>Invoice No :</strong> {{$invoice_no}}</p>
                            <p style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; line-height: 1.2; color: #333;"><strong>Invoice Date :</strong> {{$invoice_date}} </p>
                        </td>
                    </tr>
                    <tr>
                        <td height="30"></td>
