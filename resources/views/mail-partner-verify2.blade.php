        ...
        <tr>
            <td align="center">
                <table width="600px" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            ...
                            <p style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; color: #333;">
                                We’re pleased to inform you that your <strong>partner account verification is now complete,</strong> and
                                your account has been <strong>successfully activated!</strong>You can now log in and start managing
                                multiple organizations seamlessly.           
                            </p>
                            

                            <p style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; color: #333;"><strong>Next Steps:</strong></p>
                            <p style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; color: #333;"><strong>Log in to your Partner Dashboard</strong>  using the details below:</p>
                            ...
                            <p style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; color: #333;"><strong>Username :</strong> {{ $email }}</p>
                            <p style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; color: #333;"><strong><b>Password :</strong> {{ $password }}</p>
							...
							<ul style="list-style-type: disc; padding-left: 20px;">
                                <li style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; font-weight: normal;">Once logged in, go to the <strong>Landing Page or Dashboard</strong></li>
                                <li style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; font-weight: normal;">Copy your <strong>organization join link</strong></li>
                                <li style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; font-weight: normal;">Share it with the organizations you want to onboard</li>
                            </ul>
                            ...
                            <ul style="list-style-type: disc; padding-left: 20px;">
                                <li style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; font-weight: normal;">Ensure they <strong> fill in all required organizational details</strong></li>
                                <li style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; font-weight: normal;">This will help in <strong>smooth compliance and HR management</strong></li>
                            </ul>
                            ...
                            <ul style="list-style-type: disc; padding-left: 20px;">
                                <li style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; font-weight: normal;"><strong>Manage multiple organizations efficiently</strong></li>
                                <li style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; font-weight: normal;"><strong>Streamline HR processes, compliance, and workforce management</strong></li>
                                <li style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; font-weight: normal;"><strong>Leverage advanced HRMS tools for recruitment, analytics, and collaboration</strong></li>
                            </ul>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <p style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; padding: 0 20px; margin: 0;"><strong>Need Help?</strong>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; padding: 0 20px;">
                            <p style="margin: 0;">Our team is always ready to assist. Feel free to reach out for any guidance support at
                                <a href="mailto: info@skilledworkerscloud.co.uk">info@skilledworkerscloud.co.uk</a> or
                                call <a href="tel: +44 7467284718"> +44 7467284718</a></p>

                            <p style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify;">Let’s build a strong network and simplify HR management together!</p>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-size: 16px; font-family: 'Times New Roman', Times, serif; text-align: justify; padding: 0 20px;">
