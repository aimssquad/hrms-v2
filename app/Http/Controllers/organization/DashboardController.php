...
// end code
        ...
        if (!empty(Session::get('emp_email'))) {
            ...
            if ($leave_allocation_rs) {$f = 1;
				...
				<td>' . $f . '</td>
													...
													<td><a href="org-contract-agreement-edit/' . base64_encode($leave_allocation->emp_code) . '"><i class="fas fa-file-pdf"></i></a>
													<a href="org-contract-word/' . base64_encode($leave_allocation->emp_code) . '"><i class="fas fa-file-word"></i></a></td>
     ...
     public function viewemployeeagreementdit($emp_id)
    {
        ...
        if (!empty(Session::get('emp_email'))) {
            ...
            return redirect('org-dashboard/contract-agreement');
        } else {
            return redirect('/');
        }
